...
> = {
  ...
  purple: {
    light: ["#EAE5F0", "#F3F0F8", "#E8DFF5", "#0052CC", "#003DA5"],
    dark: ["#EAE5F0", "#F3F0F8", "#E8DFF5", "#0052CC", "#003DA5"],
  },
  silk: {
...
export function AnimatedFlow({
  ...
  const activeVignette = vignetteStrength ?? 0.0;
  ...
  return (
    <div
      className={cn(
        "relative w-full h-full min-h-[400px] overflow-hidden bg-white text-black transition-colors duration-300",
        className
      )}
    >
