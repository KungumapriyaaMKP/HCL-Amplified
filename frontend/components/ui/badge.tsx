  ...
  "inline-flex items-center rounded-md border px-2.5 py-0.5 text-[11px] font-bold uppercase tracking-wider transition-all",
  {
    variants: {
      ...
      tone: {
        ...
        destructive: "border-red-500/50 bg-red-950/70 text-red-300 shadow-[0_0_10px_rgba(239,68,68,0.3)]",
      },
    },
    defaultVariants: {
      variant: "default",
...
export interface BadgeProps
  ...
  tone?: "default" | "success" | "warning" | "accent" | "cyan" | "danger" | "destructive" | string;
  variant?: "default" | "secondary" | "destructive" | "danger" | "outline" | "success" | "warning" | "accent" | "cyan" | string;
}
