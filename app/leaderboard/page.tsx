  ...
  return (
    <div className="min-h-screen bg-[#F8F9FD] text-slate-900 font-sans pb-16">
      ...
      <main className="mx-auto w-full max-w-[1440px] px-4 sm:px-8 py-6 space-y-8">
          ...
          <div className="pt-6 pb-4 grid grid-cols-3 gap-3 sm:gap-8 items-end max-w-3xl mx-auto">
            ...
            {top3[1] && (
              <div className="animate-rocket-2 relative flex flex-col items-center">
                ...
                {/* Main Fuselage Body */}
                <div className="relative w-full max-w-[200px] rounded-xl border-2 border-cyan-400 bg-gradient-to-b from-[#F0F9FF] via-white to-[#E0F2FE] p-3 sm:p-4 text-center shadow-[0_8px_25px_rgba(6,182,212,0.2)] z-10">
                  
                  {/* Side Booster Fins */}
                  <div className="absolute -left-3 sm:-left-4 bottom-3 h-12 sm:h-16 w-3 sm:w-4 rounded-l-md border-l-2 border-b-2 border-t border-cyan-400 bg-gradient-to-l from-cyan-400 to-sky-500 skew-y-[35deg] shadow-xs" />
                  <div className="absolute -right-3 sm:-right-4 bottom-3 h-12 sm:h-16 w-3 sm:w-4 rounded-r-md border-r-2 border-b-2 border-t border-cyan-400 bg-gradient-to-r from-cyan-400 to-sky-500 -skew-y-[35deg] shadow-xs" />

                  {/* Cockpit Window */}
                  <div className="mx-auto mb-2 flex h-10 w-10 sm:h-12 sm:w-12 items-center justify-center rounded-full border-2 border-sky-300 bg-gradient-to-br from-sky-400 to-blue-600 shadow-sm">
                  ...
                  <span className="mt-1.5 inline-block text-[9px] font-bold uppercase tracking-wider text-sky-700 border border-sky-200 bg-sky-50 px-2 py-0.5 rounded-full">
                    {top3[1].levelTitle}
                  </span>
                </div>

                {/* Engine Exhaust Nozzle */}
                <div className="h-2.5 w-12 sm:w-16 bg-slate-800 border-x-2 border-cyan-400 rounded-b-sm z-10" />
            ...
            {top3[0] && (
              <div className="animate-rocket-1 relative flex flex-col items-center -translate-y-6 sm:-translate-y-10 z-20">
                ...
                {/* Main Fuselage Body */}
                <div className="relative w-full max-w-[230px] rounded-xl border-2 border-amber-400 bg-gradient-to-b from-[#FFFDF5] via-white to-[#FEF3C7] p-4 sm:p-5 text-center shadow-[0_10px_35px_rgba(245,158,11,0.25)] z-10">
                  
                  {/* Side Booster Fins */}
                  <div className="absolute -left-4 sm:-left-5 bottom-4 h-16 sm:h-20 w-4 sm:w-5 rounded-l-md border-l-2 border-b-2 border-t border-amber-400 bg-gradient-to-l from-amber-400 to-yellow-500 skew-y-[35deg] shadow-xs" />
                  <div className="absolute -right-4 sm:-right-5 bottom-4 h-16 sm:h-20 w-4 sm:w-5 rounded-r-md border-r-2 border-b-2 border-t border-amber-400 bg-gradient-to-r from-amber-400 to-yellow-500 -skew-y-[35deg] shadow-xs" />

                  {/* Cockpit Window with Trophy */}
                  <div className="relative mx-auto mb-2 flex h-14 w-14 sm:h-16 sm:w-16 items-center justify-center rounded-full border-2 border-amber-300 bg-gradient-to-tr from-amber-400 via-yellow-400 to-amber-200 shadow-md">
                    <IconTrophy className="h-7 w-7 sm:h-8 sm:w-8 text-amber-900 drop-shadow-xs" />
                    <span className="absolute -bottom-1.5 -right-1.5 flex h-5 w-5 sm:h-6 sm:w-6 items-center justify-center rounded-full border border-amber-400 bg-amber-400 text-[10px] sm:text-xs font-black text-amber-950 shadow-sm">
                      #1
                    </span>
                  </div>
                  ...
                  <span className="mt-1.5 inline-block text-[10px] font-bold uppercase tracking-wider text-amber-800 border border-amber-300 bg-amber-100 px-2.5 py-0.5 rounded-full shadow-xs">
                    {top3[0].levelTitle}
                  </span>
                </div>

                {/* Engine Exhaust Nozzle */}
                <div className="h-3 w-16 sm:w-20 bg-slate-800 border-x-2 border-amber-400 rounded-b-sm z-10" />
            ...
            {top3[2] && (
              <div className="animate-rocket-3 relative flex flex-col items-center">
                ...
                {/* Main Fuselage Body */}
                <div className="relative w-full max-w-[200px] rounded-xl border-2 border-orange-400 bg-gradient-to-b from-[#FFF7ED] via-white to-[#FFEDD5] p-3 sm:p-4 text-center shadow-[0_8px_25px_rgba(249,115,22,0.2)] z-10">
                  
                  {/* Side Booster Fins */}
                  <div className="absolute -left-3 sm:-left-4 bottom-3 h-12 sm:h-16 w-3 sm:w-4 rounded-l-md border-l-2 border-b-2 border-t border-orange-400 bg-gradient-to-l from-orange-400 to-amber-500 skew-y-[35deg] shadow-xs" />
                  <div className="absolute -right-3 sm:-right-4 bottom-3 h-12 sm:h-16 w-3 sm:w-4 rounded-r-md border-r-2 border-b-2 border-t border-orange-400 bg-gradient-to-r from-orange-400 to-amber-500 -skew-y-[35deg] shadow-xs" />

                  {/* Cockpit Window */}
                  <div className="mx-auto mb-2 flex h-10 w-10 sm:h-12 sm:w-12 items-center justify-center rounded-full border-2 border-amber-300 bg-gradient-to-br from-amber-500 to-orange-600 shadow-sm">
                  ...
                  <span className="mt-1.5 inline-block text-[9px] font-bold uppercase tracking-wider text-orange-700 border border-orange-200 bg-orange-50 px-2 py-0.5 rounded-full">
                    {top3[2].levelTitle}
                  </span>
                </div>

                {/* Engine Exhaust Nozzle */}
                <div className="h-2.5 w-12 sm:w-16 bg-slate-800 border-x-2 border-orange-500 rounded-b-sm z-10" />
        ...
        <div className="rounded-2xl border border-slate-200/80 bg-white p-6 shadow-xs max-w-4xl mx-auto">
          <div className="border-b border-slate-100 pb-3 mb-3 px-3 flex items-center justify-between text-[10px] font-bold uppercase tracking-wider text-slate-400">
                ...
                <div
                  ...
                  className={`flex items-center justify-between rounded-xl border p-3.5 transition-all ${
                    row.rank === 1
                      ...
                      : "border-slate-100 bg-slate-50/50 hover:bg-white hover:border-slate-200 hover:shadow-xs"
                  }`}
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex items-center gap-3">
                      <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-purple-100 border border-purple-200 text-xs font-bold text-purple-700 shadow-xs">
