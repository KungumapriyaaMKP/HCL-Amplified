...
/* -------------------------------------------------------------------------
 * EXACT HIGH-FIDELITY VECTOR BADGES MATCHING THE REFERENCE DESIGN
 * ------------------------------------------------------------------------- */

function WebDevBadge() {
  return (
    <div className="w-13 h-13 sm:w-14 sm:h-14 rounded-xl bg-[#F3E8FF] flex items-center justify-center shrink-0">
      <svg viewBox="0 0 40 40" fill="none" className="w-8 h-8" xmlns="http://www.w3.org/2000/svg">
        <rect x="6" y="9" width="28" height="22" rx="4" fill="#6D28D9" />
        <rect x="6" y="9" width="28" height="6" rx="4" fill="#5B21B6" />
        <circle cx="10" cy="12" r="1" fill="#E9D5FF" />
        <circle cx="13.5" cy="12" r="1" fill="#E9D5FF" />
        <circle cx="17" cy="12" r="1" fill="#E9D5FF" />
        <path d="M15 20 L12 23 L15 26" stroke="#FFFFFF" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M18.5 27 L21.5 19" stroke="#FFFFFF" strokeWidth="1.6" strokeLinecap="round" />
        <path d="M25 20 L28 23 L25 26" stroke="#FFFFFF" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    </div>
  );
}
...
function DataScienceBadge() {
  return (
    <div className="w-13 h-13 sm:w-14 sm:h-14 rounded-xl bg-[#E0F2FE] flex items-center justify-center shrink-0">
      <svg viewBox="0 0 40 40" fill="none" className="w-8 h-8" xmlns="http://www.w3.org/2000/svg">
        <rect x="9" y="22" width="5" height="10" rx="1.5" fill="#0284C7" />
        <rect x="17.5" y="15" width="5" height="17" rx="1.5" fill="#0284C7" />
        <rect x="26" y="19" width="5" height="13" rx="1.5" fill="#0284C7" />
...
function AiMlBadge() {
  return (
    <div className="w-13 h-13 sm:w-14 sm:h-14 rounded-xl bg-[#DCFCE7] flex items-center justify-center shrink-0">
      <svg viewBox="0 0 40 40" fill="none" className="w-8 h-8" xmlns="http://www.w3.org/2000/svg">
        <path
        ...
        <path
          ...
          fill="none"
        />
        <line x1="20" y1="8" x2="20" y2="32.5" stroke="#16A34A" strokeWidth="2" strokeLinecap="round" />
        <path d="M15.5 14 C18 15, 18 18, 15.5 19" stroke="#22C55E" strokeWidth="1.8" strokeLinecap="round" fill="none" />
        <path d="M24.5 14 C22 15, 22 18, 24.5 19" stroke="#22C55E" strokeWidth="1.8" strokeLinecap="round" fill="none" />
      </svg>
    </div>
  );
}
...
function MobileDevBadge() {
  return (
    <div className="w-13 h-13 sm:w-14 sm:h-14 rounded-xl bg-[#FCE7F3] flex items-center justify-center shrink-0">
      <svg viewBox="0 0 40 40" fill="none" className="w-8 h-8" xmlns="http://www.w3.org/2000/svg">
        <rect x="13" y="8" width="14" height="24" rx="3.5" stroke="#DB2777" strokeWidth="2" fill="none" />
        <line x1="17" y1="11.5" x2="23" y2="11.5" stroke="#DB2777" strokeWidth="1.8" strokeLinecap="round" />
...
function CloudDevOpsBadge() {
  return (
    <div className="w-13 h-13 sm:w-14 sm:h-14 rounded-xl bg-[#FEF3C7] flex items-center justify-center shrink-0">
      <svg viewBox="0 0 40 40" fill="none" className="w-8 h-8" xmlns="http://www.w3.org/2000/svg">
        <path
          ...
          fill="none"
        />
        <line x1="13" y1="21.5" x2="27" y2="21.5" stroke="#D97706" strokeWidth="1.6" strokeLinecap="round" />
      </svg>
    </div>
  );
}
...
function CybersecurityBadge() {
  return (
    <div className="w-13 h-13 sm:w-14 sm:h-14 rounded-xl bg-[#EDE9FE] flex items-center justify-center shrink-0">
      <svg viewBox="0 0 40 40" fill="none" className="w-8 h-8" xmlns="http://www.w3.org/2000/svg">
        <path
          ...
          fill="none"
        />
        <rect x="17.5" y="19" width="5" height="4.5" rx="1" fill="#6D28D9" />
...
function GameDevBadge() {
  return (
    <div className="w-13 h-13 sm:w-14 sm:h-14 rounded-xl bg-[#FCE7F3] flex items-center justify-center shrink-0">
      <svg viewBox="0 0 40 40" fill="none" className="w-8 h-8" xmlns="http://www.w3.org/2000/svg">
        <rect x="8" y="13" width="24" height="14" rx="7" fill="#DB2777" />
        {/* D-Pad */}
        <path d="M13 18 V22 M11 20 H15" stroke="#FDF2F8" strokeWidth="1.6" strokeLinecap="round" />
        {/* Buttons */}
...
function UiUxDesignBadge() {
  return (
    <div className="w-13 h-13 sm:w-14 sm:h-14 rounded-xl bg-[#FFE4E6] flex items-center justify-center shrink-0">
      <svg viewBox="0 0 40 40" fill="none" className="w-8 h-8" xmlns="http://www.w3.org/2000/svg">
        <rect x="11" y="9" width="18" height="22" rx="3.5" fill="#E11D48" />
        <circle cx="16" cy="14" r="1.8" fill="#FFE4E6" />
        <line x1="14" y1="20" x2="26" y2="20" stroke="#FFE4E6" strokeWidth="1.6" strokeLinecap="round" />
        <line x1="14" y1="24" x2="22" y2="24" stroke="#FFE4E6" strokeWidth="1.6" strokeLinecap="round" />
      </svg>
    </div>
  );
}
...
function GenAiBadge() {
  return (
    <div className="w-13 h-13 sm:w-14 sm:h-14 rounded-xl bg-[#FAE8FF] flex items-center justify-center shrink-0">
      <svg viewBox="0 0 40 40" fill="none" className="w-8 h-8" xmlns="http://www.w3.org/2000/svg">
...
function DataEngineeringBadge() {
  return (
    <div className="w-13 h-13 sm:w-14 sm:h-14 rounded-xl bg-[#CCFBF1] flex items-center justify-center shrink-0">
      <svg viewBox="0 0 40 40" fill="none" className="w-8 h-8" xmlns="http://www.w3.org/2000/svg">
...
function EnterpriseFullStackBadge() {
  return (
    <div className="w-13 h-13 sm:w-14 sm:h-14 rounded-xl bg-[#DBEAFE] flex items-center justify-center shrink-0">
      <svg viewBox="0 0 40 40" fill="none" className="w-8 h-8" xmlns="http://www.w3.org/2000/svg">
        <rect x="9" y="9" width="22" height="6.5" rx="2" fill="#2563EB" />
        <rect x="9" y="17" width="22" height="6.5" rx="2" fill="#3B82F6" />
        <rect x="9" y="25" width="22" height="6.5" rx="2" fill="#60A5FA" />
...
function EmbeddedIotBadge() {
  return (
    <div className="w-13 h-13 sm:w-14 sm:h-14 rounded-xl bg-[#FEF9C3] flex items-center justify-center shrink-0">
      <svg viewBox="0 0 40 40" fill="none" className="w-8 h-8" xmlns="http://www.w3.org/2000/svg">
        <rect x="12" y="12" width="16" height="16" rx="2.5" fill="#CA8A04" />
        <rect x="15" y="15" width="10" height="10" rx="1.5" fill="#FEF08A" />
        <line x1="12" y1="16" x2="8" y2="16" stroke="#854D0E" strokeWidth="1.6" strokeLinecap="round" />
        <line x1="12" y1="24" x2="8" y2="24" stroke="#854D0E" strokeWidth="1.6" strokeLinecap="round" />
        <line x1="28" y1="16" x2="32" y2="16" stroke="#854D0E" strokeWidth="1.6" strokeLinecap="round" />
        <line x1="28" y1="24" x2="32" y2="24" stroke="#854D0E" strokeWidth="1.6" strokeLinecap="round" />
      </svg>
    </div>
  );
}
  ...
  return (
    <div className="w-13 h-13 sm:w-14 sm:h-14 rounded-xl bg-[#FFE4E6] flex items-center justify-center shrink-0">
      <svg viewBox="0 0 40 40" fill="none" className="w-8 h-8" xmlns="http://www.w3.org/2000/svg">
        ...
        <path d="M12 20 L16 20 L18.5 14 L22 26 L24.5 20 L28 20" stroke="#BE123C" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" fill="none" />
      </svg>
    </div>
  );
}
...
function QaAutomationBadge() {
  return (
    <div className="w-13 h-13 sm:w-14 sm:h-14 rounded-xl bg-[#D1FAE5] flex items-center justify-center shrink-0">
      <svg viewBox="0 0 40 40" fill="none" className="w-8 h-8" xmlns="http://www.w3.org/2000/svg">
        <rect x="10" y="8" width="20" height="24" rx="2.5" fill="#059669" />
        <path d="M14 16 L17 19 L23 13" stroke="#A7F3D0" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M14 23 L17 26 L23 20" stroke="#A7F3D0" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    </div>
  );
}
...
function MainframeBadge() {
  return (
    <div className="w-13 h-13 sm:w-14 sm:h-14 rounded-xl bg-[#E2E8F0] flex items-center justify-center shrink-0">
      <svg viewBox="0 0 40 40" fill="none" className="w-8 h-8" xmlns="http://www.w3.org/2000/svg">
        <rect x="8" y="9" width="12" height="22" rx="2" fill="#334155" />
        <circle cx="12" cy="13" r="1.2" fill="#38BDF8" />
        <circle cx="12" cy="17" r="1.2" fill="#34D399" />
        <path d="M22 20 L26 20 M26 20 L24 17 M26 20 L24 23" stroke="#2563EB" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
...
function SapErpBadge() {
  return (
    <div className="w-13 h-13 sm:w-14 sm:h-14 rounded-xl bg-[#DBEAFE] flex items-center justify-center shrink-0">
      <svg viewBox="0 0 40 40" fill="none" className="w-8 h-8" xmlns="http://www.w3.org/2000/svg">
        <rect x="9" y="14" width="22" height="16" rx="2" fill="#1D4ED8" />
...
function ProductManagementBadge() {
  return (
    <div className="w-13 h-13 sm:w-14 sm:h-14 rounded-xl bg-[#FFEDD5] flex items-center justify-center shrink-0">
      <svg viewBox="0 0 40 40" fill="none" className="w-8 h-8" xmlns="http://www.w3.org/2000/svg">
        <rect x="10" y="13" width="20" height="16" rx="2.5" fill="#EA580C" />
        <path d="M16 13 V10 C16 9.2, 16.8 8.5, 17.5 8.5 H22.5 C23.2 8.5, 24 9.2, 24 10 V13" stroke="#C2410C" strokeWidth="1.6" fill="none" />
        <rect x="18" y="19" width="4" height="4" rx="1" fill="#FFFFFF" />
      </svg>
    </div>
  );
}
  ...
  return (
    <div className="flex min-h-screen bg-[#F8F9FD] text-slate-900 font-sans">
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-y-auto max-h-screen">
            ...
            <div className="flex items-center gap-3 self-start sm:self-auto">
              <div className="relative w-60 sm:w-72">
                ...
                <input
                  ...
                  className="w-full pl-9.5 pr-4 py-2 text-xs rounded-full border border-slate-200/90 bg-white placeholder-slate-400 focus:outline-none focus:border-[#6D28D9] focus:ring-1 focus:ring-[#6D28D9] shadow-2xs transition-all"
                />
              </div>

              <NotificationDropdown />

              <div className="flex h-9 w-9 items-center justify-center rounded-full bg-gradient-to-tr from-[#6D28D9] to-[#8B5CF6] text-xs font-black text-white shadow-xs">
                K
              </div>
            </div>
          </div>
        ...
        {/* ================= STEP 0: 2 SECTIONS (STUDENT & CORPORATE) EXACT MATCH TO IMAGE ================= */}
        {step === 0 && (
              ...
              <div className="space-y-4">
                <div className="space-y-0.5">
                  <div className="flex items-center gap-2.5">
                    ...
                    <span className="text-[11px] font-bold px-2.5 py-0.5 rounded-full bg-purple-100/80 text-[#6D28D9]">
                      9 Programs
                    </span>
                  </div>
                  ...
                  {studentDomains.map((d) => {
                    ...
                    return (
                      <div
                        ...
                        className={`group relative flex items-center justify-between gap-4 rounded-xl border bg-white p-4.5 sm:p-5 transition-all duration-200 cursor-pointer min-h-[105px] ${
                          isSelected
                            ? "border-2 border-indigo-400 shadow-sm"
                            : "border-slate-200/90 hover:border-purple-300 hover:shadow-md"
                        }`}
                      >
                        {/* Left: Circular/Rounded Icon Avatar */}
                        {d.badge}
              ...
              <div className="space-y-4 pt-1">
                <div className="space-y-0.5">
                  <div className="flex items-center gap-2.5">
                    ...
                    <span className="text-[11px] font-bold px-2.5 py-0.5 rounded-full bg-blue-100/80 text-blue-700">
